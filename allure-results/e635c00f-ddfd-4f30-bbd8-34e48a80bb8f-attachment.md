...
> 14 |     frame_1.locator('input[name="mytext1"]').fill("Hello Class")
     |             ^ TypeError: Cannot read properties of null (reading 'locator')
  15 | 
  16 |     //2.Using locator
  ...
  27 |    
  28 | //     await page.locator('frame').nth(2).contentFrame().getByText('Loading...').contentFrame().getByRole('radio', { name: 'Hi, I am the UI.Vision IDE' }).click()
  29 |     
  30 | // })
```