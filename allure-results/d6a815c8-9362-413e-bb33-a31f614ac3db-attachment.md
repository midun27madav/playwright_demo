...
- Name: Screenshot.spec.js >> Page screenshot
- Location: tests\Screenshot.spec.js:3:5
...
> 5  |     await page.screenshot({path:"HomePage.png"+Date.now()})
     |                ^ Error: path: unsupported mime type "null"
  6  | })
  7  | 
  8  | 
  ...
  12 | 
  13 | 
  14 | // test('Element screenshot', async ({page})=>{
  15 |     
  16 | // })
```