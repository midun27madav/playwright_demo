...
Call log:
  - waiting for locator('frame[src="frame_3.html"]').contentFrame().locator('input[name="mytext3"]').locator('iframe').contentFrame().locator('//*[@id="i6"]/div[3]/div')
...
> 29 |     await childFrames.locator('//*[@id="i6"]/div[3]/div').check()
     |                                                           ^ Error: locator.check: Test timeout of 30000ms exceeded.
  30 | })
```